...
import IndexPlans from "../Management/Plans/IndexPlans.js";
    ...
    return (
        <>
            ...
            <section className="header overflow-hidden relative pt-16 items-center flex h-screen max-h-860-px">
                <div className="container mx-auto items-center flex flex-wrap  lg:pr-28 lg:pl-28">
                    <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
                        <div className="pt-32 sm:pt-0">
                            ...
                            <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                                Numidia is composed of three departements
                                Numidia school, profession and academy where you
                                learn in any education system whatever your
                                level is of any major for a reasonable prices,
                                choose the plan you are comfor with.
                            </p>
                            <div className="mt-12">
                                <Link
                                    to={"/about"}
            ...
            <section className="block relative pt-10 pb-10 bg-slate-100 lg:pr-28 lg:pl-28">
                    ...
                    <div className="flex flex-wrap justify-center ">
                        <div className="w-full md:w-1/2 px-12 md:px-4 ml-auto mr-auto flex flex-col justify-center items-center">
                            ...
                            <p className="text-lg font-light leading-relaxed mt-4 mb-4 w-full">
                                You can get our application on your andriod
                                phone now. Just click the button bellow
                            </p>
                            <p className="text-lg font-light leading-relaxed mt-0 mb-4 w-full">
                                Numidia app is simple app for phone users it's
                                facilate and speed up the registeration process.
                            </p>
                            <a
                        ...
                        <div className="w-full md:w-1/2 px-4 mr-auto ml-auto  lg:scale-125 overflow-visible">
                            <img
            ...
            <section className="block relative z-1 bg-slate-100 pt-20 pb-10">
                <div className="justify-center text-center flex flex-wrap mt-5 mb-5">
                    <div className="w-full md:w-6/12 px-12 md:px-4">
                        ...
                        <p className="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
                            ...
                            school, profession and academy where you learn in
                            any education system whatever your level is of any
                            major for a reasonable prices, what are waiting
                            choose your major and REGISTER NOW.
                        </p>
                    </div>
                </div>
                <div className="container mx-auto">
            ...
            <section
                className="relative z-20 overflow-hidden bg-white pt-20 pb-12  lg:pb-[90px]"
                id="school"
            >
                <div className="container mx-auto">
                        ...
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                                ...
                                <p className="text-body-color text-base">
                                    Numidia School is the place for your
                                    academic excellence
                                </p>
                            </div>
                        </div>
                    </div>
                    <IndexPlans branch={"numidia school"} />
                </div>
            </section>
            <section
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                                ...
                                <p className="text-body-color text-base">
                                    Numidia Academy is the place for your
                                    academic excellence
                                </p>
                            </div>
                        </div>
                    </div>
                    <IndexPlans branch={"numidia academy"} />
                </div>
            </section>
            <section
                className="relative z-20 overflow-hidden bg-white  pb-12  lg:pb-[90px]"
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                                ...
                                <p className="text-body-color text-base">
                                    Numidia Profession is the place for your
                                    academic excellence
                                </p>
                            </div>
                        </div>
                    </div>
                    <IndexPlans branch={"numidia profession"} />
                </div>
            </section>
